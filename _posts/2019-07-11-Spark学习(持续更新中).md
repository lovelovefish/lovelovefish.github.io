...
<a href="#Spark核心RDD">Spark核心RDD</a>

<a href="#RDD API">RDD API</a>

<a href="#RDD的宽窄依赖">RDD的宽窄依赖</a>
...
#### <a name="Spark核心RDD">Spark核心RDD</a>
...
#### <a name="Spark的广播变量和累加器">Spark的广播变量和累加器</a>
...
1. 广播变量（Broadcast Variable）
   ...
   **<font color="red">a）变量一旦被定义为一个广播变量，那么这个变量只能读，不能修改</font>**

   **<font color="red">b）不能将RDD广播出去，因为RDD是不存储数据的，但可以将RDD的结果广播出去</font>**

   **<font color="red">c）广播变量只能在Driver端定义，不能在Executor端定义</font>**

   **<font color="red">d）在Driver端可以修改广播变量的值，在Executor端无法修改广播变量的值</font>**

   **<font color="red">e）如果executor端用到了Driver的变量，如果不使用广播变量在Executor有多少task就有多少Driver端的变量副本</font>**

   **<font color="red">f）如果Executor端用到了Driver的变量，如果使用广播变量在每个Executor中只有一份Driver端的变量副本</font>**
...
2. 累加器（Accumulators）
   ...
   **<font color="red">a）累加器在Driver端定义赋初始值，累加器只能在Driver端读取最后的值，在Excutor端更新</font>**
